...
Odds are equivalent to ratios of probabilities. For example, "two to one odds that Donald Trump wins presidency" means "the probability that Ted Cruz wins is double the probability he loses". So, if odds = 2, $p(x)=2/3$. If odds = 1/2, $p(x)=1/3$. In general odds = $\frac{p(x)}{1-p(x)}$.
