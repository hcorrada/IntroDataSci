...
The notion of _tidy data_ as precented here is purposefully parallel to the ER model formalism commonly used in the database field. However, this formalism extends beyond what we've seen here targeted towards data analysis. Many features of the ER model formalism are more applicable to data management issues, especially consistency and redundancy. 
