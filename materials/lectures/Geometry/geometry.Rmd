...
For example, we will sometimes call attributes $Y$ and $X$ the
...
We can represent each instance as a _vector_ in Euclidean space $\langle x_1,\ldots,x_p,y \rangle$. This means:
