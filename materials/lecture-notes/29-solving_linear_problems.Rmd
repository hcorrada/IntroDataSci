...
```{r, echo=FALSE, cache=FALSE, fig.height=10, fig.width=15}
n <- length(y)
...
```{r, echo=FALSE, warning=FALSE, cache=FALSE, dev='png', animation.hook='gifski'}
...
```{r, eval=FALSE, echo=FALSE, fig.width=15, fig.height=10, cache=FALSE}
...
```{r, echo=FALSE, warning=FALSE, dev='png', cache=FALSE, animation.hook='gifski'}
yloss <- sapply(beta, compute_loss, x=x, y=y)
beta_trace <- res2[[2]]
loss_trace <- res2[[3]]
