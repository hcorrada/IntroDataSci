# Principles: Measurements and Data Types
...
Distinctions between categorical and discrete numerical data is that categorical data is not ordered and finite, discrete numeric data is (possibly) infinite and ordered.
