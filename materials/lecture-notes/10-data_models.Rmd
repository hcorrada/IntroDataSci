...
Relationships are defined over _pairs_ of entities. As such, relationship $R$ over sets of entities $E_1$ and $E_2$ is defined over the crossproduct set $E_1 \times E_2$. For example, if $e_1 \in E_1$ and $e_2 \in E_2$, then  $(e_1, e_2) \in R$.
