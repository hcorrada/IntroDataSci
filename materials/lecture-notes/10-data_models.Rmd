...
In this section we will principles of preparing and organizing data in a way that is amenable for analysis, both in modeling and visualization. We think of a _data model_ as a collection of concepts that describes how data is represented and accessed. Thinking abstractly of data structure, beyond a specific implementation, makes it easier to share data across programs and systems, and integrate data from different sources.
...
In the database literature, we call this exercise of defining structure and semantics as _data modeling_. In this course we use teh term _data representational modeling_, to distinguish from _data statistical modeling_. The context should be sufficient to distinguish the two uses of the term _data modeling_.
