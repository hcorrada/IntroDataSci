...
To use python, we prefer to use [Anaconda](https://www.anaconda.com/) a great platform for package and software management, especially for data science.
...
To install the tools needed for the course, we have provided an environment file that lists all software we will use. To create an
Anaconda environment use `conda env create -f <env_file>.yml`

Once installed and loaded (with `conda activate <env>`, we recommend you use jupyter lab for this course. Start it using `jupyter lab`.
