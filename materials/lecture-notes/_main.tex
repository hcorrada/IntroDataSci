...
\includegraphics{_main_files/figure-latex/test_bbg-1.pdf}
...
\NormalTok{arrest_tab$age[}\DecValTok{1}\NormalTok{:}\DecValTok{10}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{head}\NormalTok{(arrest_tab[arrest_tab$age <}\StringTok{ }\DecValTok{21}\NormalTok{, ])}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{head}\NormalTok{(arrest_tab[arrest_tab$neighborhood ==}\StringTok{ "Mount Washington"}\NormalTok{,])}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{indices <-}\StringTok{ }\NormalTok{arrest_tab$age <}\StringTok{ }\DecValTok{21} \NormalTok{&}\StringTok{ }\NormalTok{arrest_tab$neighborhood ==}\StringTok{ "Mount Washington"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(arrest_tab$sex)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(arrest_tab$race)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{mean}\NormalTok{(arrest_tab$age)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{median}\NormalTok{(arrest_tab$age)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{summary}\NormalTok{(arrest_tab$incidentOffense)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{summary}\NormalTok{(arrest_tab$age)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{mount_washington_index <-}\StringTok{ }\NormalTok{arrest_tab$neighborhood ==}\StringTok{ "Mount Washington"}

\KeywordTok{mean}\NormalTok{(arrest_tab$age[mount_washington_index], }\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{boxplot}\NormalTok{(arrest_tab$age[mount_washington_index])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{barplot}\NormalTok{(}\KeywordTok{table}\NormalTok{(mount_washington_tab$race), }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{analyze_neighborhood <-}\StringTok{ }\NormalTok{function(neighborhood) \{}
  \NormalTok{neighborhood_index <-}\StringTok{ }\NormalTok{arrest_tab$neighborhood ==}\StringTok{ }\NormalTok{neighborhood}
  \NormalTok{neighborhood_tab <-}\StringTok{ }\NormalTok{arrest_tab[neighborhood_index,]}
  
    \KeywordTok{boxplot}\NormalTok{(neighborhood_tab$age~neighborhood_tab$sex,}
            \DataTypeTok{main =} \NormalTok{neighborhood,}
            \DataTypeTok{xlab =} \StringTok{"Sex"}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{"Arrest Age"}\NormalTok{)}
    
    \KeywordTok{barplot}\NormalTok{(}\KeywordTok{table}\NormalTok{(neighborhood_tab$race),}
            \DataTypeTok{main =} \NormalTok{neighborhood,}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{class}\NormalTok{(arrest_tab$sex)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{arrest_tab$sex <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(arrest_tab$sex)}
\KeywordTok{summary}\NormalTok{(arrest_tab$sex)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{levels}\NormalTok{(arrest_tab$sex)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{str}\NormalTok{(arrest_tab$Location)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{age_in_months <-}\StringTok{ }\NormalTok{arrest_tab$age *}\StringTok{ }\DecValTok{12}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{index_vector <-}\StringTok{ }\NormalTok{arrest_tab$sex ==}\StringTok{ "M"} \NormalTok{&}\StringTok{ }\NormalTok{arrest_tab$district ==}\StringTok{ "SOUTHERN"}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{filter_data <-}\StringTok{ }\NormalTok{function(data) \{}
  \NormalTok{index_vector <-}\StringTok{ }\NormalTok{data$sex ==}\StringTok{ "M"} \NormalTok{&}\StringTok{ }\NormalTok{data$district ==}\StringTok{ "SOUTHERN"}
  \NormalTok{data[index_vector,]}
\NormalTok{\}}

\NormalTok{select_column <-}\StringTok{ }\NormalTok{function(data, column) \{}
...
\begin{Highlighting}[]
\NormalTok{arrest_tab %>%}
\StringTok{  }\KeywordTok{filter_data}\NormalTok{() %>%}
\StringTok{  }\KeywordTok{select_column}\NormalTok{(}\StringTok{"age"}\NormalTok{) %>%}
...
\NormalTok{dl_tab <-}\StringTok{ }\NormalTok{url %>%}
\StringTok{  }\KeywordTok{read_html}\NormalTok{() %>%}
\StringTok{  }\KeywordTok{html_node}\NormalTok{(}\StringTok{"#filmographyTbl"}\NormalTok{) %>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tidy_tb <-}\StringTok{ }\NormalTok{tb %>%}\StringTok{ }
\StringTok{  }\KeywordTok{gather}\NormalTok{(demo, n, -iso2, -year)  %>%}
...
\begin{Highlighting}[]
\NormalTok{weather %>%}
\StringTok{  }\KeywordTok{gather}\NormalTok{(day, value, d1:d31, }\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{) %>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tidy_billboard <-}\StringTok{ }\NormalTok{billboard %>%}
\StringTok{  }\KeywordTok{gather}\NormalTok{(week, rank, wk1:wk76, }\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tidy_billboard <-}\StringTok{ }\NormalTok{tidy_billboard %>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{song <-}\StringTok{ }\NormalTok{tidy_billboard %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(artist, track, year, time, date.entered) %>%}
...
\begin{Highlighting}[]
\NormalTok{song <-}\StringTok{ }\NormalTok{tidy_billboard %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(artist, track, year, time, date.entered) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{unique}\NormalTok{() %>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rank <-}\StringTok{ }\NormalTok{tidy_billboard %>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(song, }\KeywordTok{c}\NormalTok{(}\StringTok{"artist"}\NormalTok{, }\StringTok{"year"}\NormalTok{, }\StringTok{"track"}\NormalTok{, }\StringTok{"time"}\NormalTok{, }\StringTok{"date.entered"}\NormalTok{)) %>%}
...
\NormalTok{flights %>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(carrier ==}\StringTok{ "UA"}\NormalTok{)}

\CommentTok{# select even samples, note function `n` defined by dplyr}
\NormalTok{flights %>%}\StringTok{ }\KeywordTok{slice}\NormalTok{(}\KeywordTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{, }\KeywordTok{n}\NormalTok{(), }\DataTypeTok{by=}\DecValTok{2}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{flights %>%}\StringTok{ }\KeywordTok{select}\NormalTok{(month, carrier, origin)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{flights %>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{delay=}\NormalTok{dep_delay +}\StringTok{ }\NormalTok{arr_delay)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{delay =} \NormalTok{dep_delay +}\StringTok{ }\NormalTok{arr_delay) %>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{flights %>%}\StringTok{ }\KeywordTok{anti_join}\NormalTok{(airlines, }\DataTypeTok{by=}\StringTok{"carrier"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{plot}\NormalTok{(flights$dep_delay)}
\end{Highlighting}
\end{Shaded}

\includegraphics{_main_files/figure-latex/plot_delay-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(}\KeywordTok{sort}\NormalTok{(flights$dep_delay), }\DataTypeTok{type=}\StringTok{"h"}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{"Departure Delay"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{_main_files/figure-latex/plot_sorted_delay-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{hist}\NormalTok{(flights$dep_delay, }\DataTypeTok{xlab=}\StringTok{"Departure Delay"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{_main_files/figure-latex/hist_delay-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(}\KeywordTok{density}\NormalTok{(flights$dep_delay, }\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{), }\DataTypeTok{xlab=}\StringTok{"Departure Delay"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{_main_files/figure-latex/density_delay-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{boxplot}\NormalTok{(flights$dep_delay, }\DataTypeTok{ylab=}\StringTok{"Departure Delay"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{_main_files/figure-latex/boxplot_delay-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{boxplot}\NormalTok{(}\KeywordTok{log}\NormalTok{(flights$dep_delay -}\StringTok{ }
\StringTok{            }\KeywordTok{min}\NormalTok{(flights$dep_delay,}\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{)}
            \NormalTok{+}\DecValTok{1}\NormalTok{), }\DataTypeTok{ylab=}\StringTok{"Departure Delay"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{_main_files/figure-latex/boxplot_transformed_delay-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{boxplot}\NormalTok{(}\KeywordTok{log}\NormalTok{(flights$dep_delay -}\StringTok{ }\KeywordTok{min}\NormalTok{(flights$dep_delay, }\DataTypeTok{na.rm=}\OtherTok{TRUE}\NormalTok{) +}\StringTok{ }\DecValTok{1}\NormalTok{) ~}\StringTok{ }\NormalTok{flights$origin,}
        \DataTypeTok{ylab=}\StringTok{"Departure Delay"}\NormalTok{, }\DataTypeTok{xlab=}\StringTok{"Airport of origin"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{_main_files/figure-latex/delay_by_origin-1.pdf}
...
\includegraphics{_main_files/figure-latex/delay_scatter-1.pdf}
...
\NormalTok{batting %>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(yearID ==}\StringTok{ "2010"}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{AB, }\DataTypeTok{y=}\NormalTok{R)) +}
...
\NormalTok{batting %>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(yearID ==}\StringTok{ "2010"}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{AB, }\DataTypeTok{y=}\NormalTok{R, }\DataTypeTok{label=}\NormalTok{teamID)) +}
...
\NormalTok{batting %>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(yearID ==}\StringTok{ "1995"}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{AB, }\DataTypeTok{y=}\NormalTok{R)) +}
\StringTok{    }\KeywordTok{geom_point}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{batting %>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(yearID ==}\StringTok{ "2010"}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{AB, }\DataTypeTok{y=}\NormalTok{H)) +}
\StringTok{    }\KeywordTok{geom_point}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{batting %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(yearID ==}\StringTok{ "2010"}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{AB, }\DataTypeTok{y=}\NormalTok{H, }\DataTypeTok{color=}\NormalTok{lgID)) +}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() +}\StringTok{ }
\StringTok{  }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method=}\NormalTok{lm)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{batting %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(yearID ==}\StringTok{ "2010"}\NormalTok{) %>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{AB, }\DataTypeTok{y=}\NormalTok{R, }\DataTypeTok{size=}\NormalTok{HR)) +}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() +}\StringTok{ }
\StringTok{  }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method=}\NormalTok{lm)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{batting %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(yearID %in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"1995"}\NormalTok{, }\StringTok{"2000"}\NormalTok{, }\StringTok{"2010"}\NormalTok{)) %>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{AB, }\DataTypeTok{y=}\NormalTok{R, }\DataTypeTok{size=}\NormalTok{HR)) +}
\StringTok{  }\KeywordTok{facet_grid}\NormalTok{(lgID~yearID) +}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() +}\StringTok{ }
\StringTok{  }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method=}\NormalTok{lm)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Auto %>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{weight, }\DataTypeTok{y=}\NormalTok{mpg)) +}
\StringTok{    }\KeywordTok{geom_point}\NormalTok{() +}\StringTok{ }
\StringTok{    }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method=}\NormalTok{lm) +}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{auto_fit_stats <-}\StringTok{ }\NormalTok{auto_fit %>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{augmented_auto <-}\StringTok{ }\NormalTok{auto_fit %>%}
\StringTok{  }\KeywordTok{augment}\NormalTok{()}
\NormalTok{augmented_auto %>%}\StringTok{ }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{augmented_auto %>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{.fitted,}\DataTypeTok{y=}\NormalTok{.resid)) +}
\StringTok{    }\KeywordTok{geom_point}\NormalTok{() +}\StringTok{ }
...
\NormalTok{auto_fit_stats <-}\StringTok{ }\NormalTok{auto_fit %>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{()}
\NormalTok{auto_fit_stats %>%}\StringTok{ }\NormalTok{knitr::}\KeywordTok{kable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{lm}\NormalTok{(mpg~weight, }\DataTypeTok{data=}\NormalTok{Auto) %>%}
\StringTok{  }\KeywordTok{glance}\NormalTok{() %>%}
\StringTok{  }\NormalTok{knitr::}\KeywordTok{kable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{lm}\NormalTok{(mpg~weight+year, }\DataTypeTok{data=}\NormalTok{Auto) %>%}
\StringTok{  }\KeywordTok{glance}\NormalTok{() %>%}
\StringTok{  }\NormalTok{knitr::}\KeywordTok{kable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{levels}\NormalTok{(Auto$origin)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{extended_df <-}\StringTok{ }\KeywordTok{model.matrix}\NormalTok{(~}\KeywordTok{factor}\NormalTok{(origin), }\DataTypeTok{data=}\NormalTok{Auto) %>%}\StringTok{ }
\StringTok{  }\KeywordTok{as.data.frame}\NormalTok{() %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{origin =} \KeywordTok{factor}\NormalTok{(Auto$origin))}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{extended_df %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(origin ==}\StringTok{ "1"}\NormalTok{) %>%}\StringTok{ }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{extended_df %>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(origin ==}\StringTok{ "2"}\NormalTok{) %>%}\StringTok{ }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{extended_df %>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(origin ==}\StringTok{ "3"}\NormalTok{) %>%}\StringTok{ }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Auto$origin <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(Auto$origin)}
\NormalTok{extended_df <-}\StringTok{ }\KeywordTok{model.matrix}\NormalTok{(~weight+origin+weight:origin, }\DataTypeTok{data=}\NormalTok{Auto) %>%}
\KeywordTok{as.data.frame}\NormalTok{() %>%}
\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{origin =} \KeywordTok{factor}\NormalTok{(Auto$origin))}

\NormalTok{extended_df %>%}
\KeywordTok{filter}\NormalTok{(origin ==}\StringTok{ "1"}\NormalTok{) %>%}\StringTok{ }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{extended_df %>%}
\KeywordTok{filter}\NormalTok{(origin ==}\StringTok{ "2"}\NormalTok{) %>%}\StringTok{ }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{extended_df %>%}
\KeywordTok{filter}\NormalTok{(origin ==}\StringTok{ "3"}\NormalTok{) %>%}\StringTok{ }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{Auto %>%}
\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{weight, }\DataTypeTok{y=}\NormalTok{mpg, }\DataTypeTok{color=}\NormalTok{origin)) +}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{auto_fit <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(mpg~weight*origin, }\DataTypeTok{data=}\NormalTok{Auto)}
\NormalTok{auto_fit_stats <-}\StringTok{ }\NormalTok{auto_fit %>%}
\StringTok{  }\KeywordTok{tidy}\NormalTok{() }
\NormalTok{auto_fit_stats %>%}\StringTok{ }\NormalTok{knitr::}\KeywordTok{kable}\NormalTok{()}
\end{Highlighting}
...
\NormalTok{gapminder %>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\KeywordTok{factor}\NormalTok{(year), }\DataTypeTok{y=}\NormalTok{lifeExp)) +}
...
\section{Capstone 2 Project}\label{capstone-2-project}
...
\section{Publishing Analyses with R}\label{publishing-analyses-with-r}
...
\section{Teaching with R}\label{teaching-with-r}
...
\subsection{Free and open source}\label{free-and-open-source}
...
\subsection{Wide range of activities}\label{wide-range-of-activities}
...
\section{Day 3 Capstone Project}\label{day-3-capstone-project}
