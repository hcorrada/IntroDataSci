...
spheres of human social and creative activity, many questions in the humanities and social sciences may be addressed by characterizing patterns in data. 

---

## Data Science in Humanities and Social Sciences

In the humanities, this can range from unproblematic questions:
...
In the social sciences, issues of fairness and transparency in the current era of big data are especially problematic. 
...
This course will cover basics of how to use the R data analysis environment for data science activities in humanities and social science. 
...
- What we can do is find the movie in each group that is closest to the average and use that movie title to annotate each group in the plot.
...
```{r test_bbg, cache=TRUE, message=FALSE, fig.height=5}
