...
**Problem 4** To test your programs, simulate data from the linear regression and logistic regression models and check that your implementations recover the simulation parameters properly. **WE WILL PROVIDE CODE TO DO THIS LATER**

## Try it out

(a) Find a dataset on which to try out different classification algorithms. You can use the dataset used in the "datatypes" assignment earlier this semester if appropriate. 
...
Knit the Rmarkdown file and submit to ELMS (LINK FORTHCOMING).
