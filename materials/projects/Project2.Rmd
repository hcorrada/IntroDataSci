...
Include the SQL code you used to create this relation in your writeup. Describe how you dealt with any missing data in these two relations. Specifically, indicate if there is missing data in either table, and how the type of join you used determines how you dealt with this missing data.
...
Knit your Rmarkdown file containing all code and text to solve each problem and answer each question. Submit to ELMS at [https://myelms.umd.edu/courses/1177854/assignments/4131990](https://myelms.umd.edu/courses/1177854/assignments/4131990).
